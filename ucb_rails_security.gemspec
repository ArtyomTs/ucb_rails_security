...
Gem::Specification.new do |s|
  ...
  s.date = "2009-03-24"
  s.description = "Simplifies CAS auth and ldap authz within your rails application"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ucb_ldap>, [">= 1.3.0"])
      s.add_runtime_dependency(%q<actionpack>, [">= 2.1.2"])
      s.add_runtime_dependency(%q<rspec>, [">= 1.1.5"])
      s.add_development_dependency(%q<echoe>, [">= 0"])
    else
      s.add_dependency(%q<rubycas-client>, [">= 2.0.1"])
      s.add_dependency(%q<ucb_ldap>, [">= 1.3.0"])
      s.add_dependency(%q<actionpack>, [">= 2.1.2"])
